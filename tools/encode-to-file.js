 ...
 * and saves it to a text file for easy copying
 * 
 * Usage: node encode-to-file.js path/to/your/google-credentials.json
 */
...
if (!filePath) {
  ...
  console.error('Usage: node encode-to-file.js path/to/your/google-credentials.json');
  process.exit(1);
}
...
try {
  ...
  console.log(`\nBase64-encoded credentials saved to: ${outputPath}`);
  console.log('Copy the contents of this file and add it as the GOOGLE_CREDENTIALS_BASE64 environment variable on Render.com');
